~~((core, w, d, reff) => {
    ...
    ~~(register => register.register(register))({
        ...
        events: {
                ...
                actions: {
                    'click .icon-row-delete': (e, v, r, i) => {
                        core.utils.confirmModal({
                            ...
                            message: `Are you sure want to remove customer "${r.name}" ?`,
            ...
            form: {
                save: () => $('form#editorForm').submit(e => {
                    ...
                    if (cdata.name === '' || cdata.nik === '' || cdata.hp === '' || cdata.email === '') {
        ...
        utils: {
            ...
            setForm: ({ id, name, hp, nik, email, cb }) => {
                $('input#txtId').val(id);
                $('input#txtName').val(name);
                $('input#txtNik').val(nik);
                $('input#txtHp').val(hp);
    ...
    document,
    {
        ...
        curl: `${window.location.origin}/api/Customers`,
        dom: {
            modal: null
        }
    }
